        ...
        handle = user.child((email?.uid)!).child("Total Steps").observe(.value, with: { (snapshot) in
            ...
            if let value = snapshot.value as? String{
                if value != ""{
                    ...
                    let quote = self.ref.child("Quote")
                    
                    if steps_for_k! >= 5000{
                        self.handle = quote.child("Easy").child("Q1").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_easy_quote1.textColor = UIColor.green
                                self.lbl_easy_quote1.text = my_quote
                            }else{
                                self.lbl_easy_quote1.textColor = UIColor.green
                    ...
                    if steps_for_k! >= 10000{
                        self.handle = quote.child("Easy").child("Q2").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_easy_quote2.textColor = UIColor.green
                                self.lbl_easy_quote2.text = my_quote
                            }else{
                                self.lbl_easy_quote2.textColor = UIColor.green
                    ...
                    if steps_for_k! >= 20000{
                        self.handle = quote.child("Easy").child("Q3").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_easy_quote3.textColor = UIColor.green
                                self.lbl_easy_quote3.text = my_quote
                            }else{
                                self.lbl_easy_quote3.textColor = UIColor.green
                    ...
                    if steps_for_k! >= 40000{
                        self.handle = quote.child("Easy").child("Q4").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_easy_quote4.textColor = UIColor.green
                                self.lbl_easy_quote4.text = my_quote
                            }else{
                                self.lbl_easy_quote4.textColor = UIColor.green
                    ...
                    if steps_for_k! >= 70000{
                        self.handle = quote.child("Normal").child("Q1").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_normal_quote1.textColor = UIColor.blue
                                self.lbl_normal_quote1.text = my_quote
                            }else{
                                self.lbl_normal_quote1.textColor = UIColor.blue
                    ...
                    if steps_for_k! >= 100000{
                        self.handle = quote.child("Normal").child("Q2").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_normal_quote2.textColor = UIColor.blue
                                self.lbl_normal_quote2.text = my_quote
                            }else{
                                self.lbl_normal_quote2.textColor = UIColor.blue
                    ...
                    if steps_for_k! >= 130000{
                        self.handle = quote.child("Normal").child("Q3").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_normal_quote3.textColor = UIColor.blue
                                self.lbl_normal_quote3.text = my_quote
                            }else{
                                self.lbl_normal_quote3.textColor = UIColor.blue
                    ...
                    if steps_for_k! >= 160000{
                        self.handle = quote.child("Normal").child("Q4").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_normal_quote4.textColor = UIColor.blue
                                self.lbl_normal_quote4.text = my_quote
                            }else{
                                self.lbl_normal_quote4.textColor = UIColor.blue
                    ...
                    if steps_for_k! >= 200000{
                        self.handle = quote.child("Hard").child("Q1").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_hard_quote1.textColor = UIColor.orange
                                self.lbl_hard_quote1.text = my_quote
                            }else{
                                self.lbl_hard_quote1.textColor = UIColor.orange
                    ...
                    if steps_for_k! >= 240000{
                        self.handle = quote.child("Hard").child("Q2").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_hard_quote2.textColor = UIColor.orange
                                self.lbl_hard_quote2.text = my_quote
                            }else{
                                self.lbl_hard_quote2.textColor = UIColor.orange
                    ...
                    if steps_for_k! >= 280000{
                        self.handle = quote.child("Hard").child("Q3").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_hard_quote3.textColor = UIColor.orange
                                self.lbl_hard_quote3.text = my_quote
                            }else{
                                self.lbl_hard_quote3.textColor = UIColor.orange
                    ...
                    if steps_for_k! >= 320000{
                        self.handle = quote.child("Hard").child("Q4").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_hard_quote4.textColor = UIColor.orange
                                self.lbl_hard_quote4.text = my_quote
                            }else{
                                self.lbl_hard_quote4.textColor = UIColor.orange
                    ...
                    if steps_for_k! >= 370000{
                        self.handle = quote.child("Legend").child("Q1").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_legendary_quote1.textColor = UIColor.red
                                self.lbl_legendary_quote1.text = my_quote
                            }else{
                                self.lbl_legendary_quote1.textColor = UIColor.red
                    ...
                    if steps_for_k! >= 420000{
                        self.handle = quote.child("Legend").child("Q2").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_legendary_quote2.textColor = UIColor.red
                                self.lbl_legendary_quote2.text = my_quote
                            }else{
                                self.lbl_legendary_quote2.textColor = UIColor.red
                    ...
                    if steps_for_k! >= 470000{
                        self.handle = quote.child("Legend").child("Q3").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_legendary_quote3.textColor = UIColor.red
                                self.lbl_legendary_quote3.text = my_quote
                            }else{
                                self.lbl_legendary_quote3.textColor = UIColor.red
                    ...
                    if steps_for_k! >= 520000{
                        self.handle = quote.child("Legend").child("Q4").observe(.value, with: { (snapshot) in
                            if snapshot.value as? String != nil{
                                let my_quote = snapshot.value as! String
                                self.lbl_legendary_quote4.textColor = UIColor.red
                                self.lbl_legendary_quote4.text = my_quote
                            }else{
                                self.lbl_legendary_quote4.textColor = UIColor.red
